...
// From http://stackoverflow.com/questions/5071743/how-to-make-an-android-view-that-flips-between-views-on-swipe-fling
...
public final class HorizontalPager extends ViewGroup {
    ...
    */
    ...
    private void init() {
        ...
        mTouchSlop = 0; //configuration.getScaledTouchSlop();
...
//            throw new IllegalStateException("ViewSwitcher can only be used in EXACTLY mode.");
                ...
                */
                if (mTouchState == TOUCH_STATE_HORIZONTAL_SCROLLING) {
                    ...
                    */
                    ...
                    boolean xMoved = xDiff > 0; //mTouchSlop;
                    if (xMoved) {
    ...
    private void snapToScreen(final int whichScreen, final int duration) {
        ...
        */
        ...
        // Callback to listener at beginning of snapping to new page.
        // Was originally done in computeScroll but that looks too late to user. -MG
        if (mOnScreenSwitchListener != null) {
            mOnScreenSwitchListener.onScreenSwitched(mNextScreen, getChildCount());
        }
        final int delta = newX - getScrollX();
        if (duration < 0) {
    ...
    public static interface OnScreenSwitchListener {
         ...
         * @param outOf  Total number of screens.
         */
        void onScreenSwitched(int screen, int outOf);
    }
}